...
<body id="home">
	...
	<nav id="sidebar-wrapper">
	    ...
	    <ul class="sidebar-nav">
			...
			<li><a href="region.php">Data Regions</a></li>
			<li><a href="person.php">Data Persons</a></li>
			<li><a href="home.php">Summary</a></li>
	...
	<header class="sticky" id="header">
		<section class="container">
			<section class="row" id="logo_menu">
				<section class="col-xs-8"><a class="logo" href="">ARSENSUS</a></section>
